...
def start_bot(client, message):
    ...
    keyboard = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text="❇ Support NetWork ❇", url=f"https://t.me/Abbassi01"),
            ],
            [
...
print(f"Amine Gpt Bot Is Active Now ✅")      
app.run()
